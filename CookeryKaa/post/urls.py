...
from .views import add_recipe, recipe_detail, feed, myprofile,otherprofile, bookmark, follow_user, like_post, add_review,bookmark_recipe,get_bookmark_status,contactus,kitchenware,recipe_detail_json
...
urlpatterns = [
    ...
    path('api/recipe/<int:pk>/', recipe_detail_json, name='recipe_detail_json'),
